          ...
          if (numused == numLights) { // No more Lights
            ...
            if (validinput) {
              ...
              for (unsigned idx = 0; idx < 4; idx++) {
                lightposn[4u * numused + idx] = values[idx];
                lightcolor[4u * numused + idx] = values[idx + 4u];
              }
        ...
        // Note that no transforms/stacks are applied to the colors.
          ...
          if (validinput) {
            ...
            for (unsigned idx = 0; idx < 3; idx++) {
              eyeinit[idx] = values[idx];
              center[idx] = values[idx + 3];
              upinit[idx] = values[idx + 6];
            }
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (numobjects == maxobjects) { // No more objects
            ...
            if (validinput) {
              ...
              if (cmd == "sphere") {
                ...
                obj->type = cube;
                std::cout << glm::to_string(obj->transform) << '\n';
              } else if (cmd == "teapot") {
                obj->type = teapot;
              }
            }
          ...
          if (validinput) {
            ...
            const mat3 &rotationMatrix =
                Transform::rotate(values[3], glm::normalize(glm::vec3(values[0], values[1], values[2])));
            rightmultiply(glm::mat4(rotationMatrix), transfstack);
          }
        }
